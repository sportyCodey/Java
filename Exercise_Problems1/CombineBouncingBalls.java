/* click on the balls to delete them. scroll the scroll bar to increase/decrease speed
* press the suspend button to pause, resume to play, + to add balls, - to delete a ball */
