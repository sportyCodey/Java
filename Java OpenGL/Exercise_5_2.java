...
public class Exercise_5_2 extends JFrame implements GLEventListener
{	private GLCanvas myCanvas;
	...
	{	GL4 gl = (GL4) GLContext.getCurrentGL();
		...
		joglBrickTexture = loadTexture("brick1.png");
	...
	public static void main(String[] args) { new Exercise_5_2(); }
	...
	{	GL4 gl = (GL4) GLContext.getCurrentGL();
		...
		String vshaderSource[] = util.readShaderSource("vert.shader.txt");
		String fshaderSource[] = util.readShaderSource("frag.shader.txt");
