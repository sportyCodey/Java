  ...
  public static void main(String[] args) {
   ...
   // list.remove(2); // Remove the element at index 2
    ...
    System.out.println("\n\nIs the element America in the LinkedList? " + list.contains("America") + "\n");
   	...
   	System.out.println("Returning everything using get() method (very slow, not preferable).");
...
/* ************************************************************************************************************************************************/
	...
	java.util.LinkedList<String> list3 = new java.util.LinkedList<>();
	java.util.LinkedList<String> list4 = new java.util.LinkedList<>();
	...
	list3.addLast("France"); // Add it to the end of the list3
