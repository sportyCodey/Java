...
public class TestPriorityQueue {
  public static void main(String[] args) {
    ...
    MyPriorityQueue<Patient> priorityQueue
      = new MyPriorityQueue<>(new PatientComparator());
  ...
  }//end inner class Patient

  static class PatientComparator implements Comparator<Patient>, java.io.Serializable {
	@Override
	public int compare(Patient o, Patient t) {
		return o.priority - t.priority;
	}
  }//end inner class PatientComparator
}//end class TestPriorityQueue
